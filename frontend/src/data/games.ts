...
export const rechargeGames: RechargeGame[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1639656333010-b6a054423b63?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1759701546668-4fe410517caf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1545579003-84eeef98a485?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    category: 'international',
    categoryName: '国际游戏',
    hot: true,
    tags: ['射击', '战术竞技'],
  ...
  },
  {
    ...
    name: 'Free Fire',
    nameEn: 'Free Fire',
    image: 'https://images.unsplash.com/photo-1659480140212-090e6e576080?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    category: 'southeast-asia',
    categoryName: '东南亚游戏',
    hot: true,
    tags: ['射击', '东南亚'],
  ...
  },
  {
    ...
    name: 'PUBG Mobile',
    nameEn: 'PUBG Mobile',
    image: 'https://images.unsplash.com/photo-1602940819863-2905852243ad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    category: 'international',
    categoryName: '国际游戏',
    hot: true,
    tags: ['射击', '战术竞技'],
  ...
  },
  {
    ...
    hot: true,
    tags: ['RPG', '回合制', '热门'],
    description: '米哈游旗下回合制RPG，提供星琼充值服务',
    paymentMethods: ['alipay', 'wechat', 'paypal', 'usdt'],
    rechargeOptions: [
      { id: '7-1', amount: '60星琼', price: 6 },
      { id: '7-2', amount: '300星琼', price: 30 },
      { id: '7-3', amount: '980星琼', price: 98, popular: true },
      { id: '7-4', amount: '1980星琼', price: 198 },
      { id: '7-5', amount: '3280星琼', price: 328 },
      { id: '7-6', amount: '6480星琼', price: 648 },
    ],
    instructions: [
      '请确认您的游戏UID正确',
      '选择对应的服务器区域',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
    category: 'international',
    categoryName: '国际游戏',
    hot: true,
    tags: ['MOBA', '竞技', '热门'],
    description: '拳头游戏旗下MOBA手游，提供点券充值服务',
    paymentMethods: ['alipay', 'wechat', 'paypal', 'usdt'],
    rechargeOptions: [
      { id: '8-1', amount: '100点券', price: 10 },
      { id: '8-2', amount: '500点券', price: 50 },
      { id: '8-3', amount: '1000点券', price: 98, popular: true },
      { id: '8-4', amount: '2000点券', price: 198 },
      { id: '8-5', amount: '3500点券', price: 328 },
      { id: '8-6', amount: '7000点券', price: 648 },
    ],
    instructions: [
      '请提供正确的游戏ID',
      '支持所有服务器',
    ...
    processingTime: '5分钟内',
    region: ['国服', '韩服', '日服', '东南亚服'],
  },
]

export const gameCategories: GameCategoryItem[] = [
  { id: 'all', name: '全部游戏', nameKey: 'allGamesCategory', icon: '🎮', gamesCount: 6 },
  { id: 'international', name: '国际游戏', nameKey: 'internationalGames', icon: '🌍', gamesCount: 3 },
  { id: 'hongkong-taiwan', name: '港台游戏', nameKey: 'hongKongTaiwanGames', icon: '🏮', gamesCount: 1 },
  { id: 'southeast-asia', name: '东南亚游戏', nameKey: 'southeastAsiaGames', icon: '🌴', gamesCount: 2 },
]
