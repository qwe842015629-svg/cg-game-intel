(function () {
  ...
  const AI_TYPESET_DISABLED_FIELD_IDS = new Set(['id_topup_info', 'id_topup_info_tw']);
  ...
  function createDefaultToolbar(textarea, shellContext = {}, options = {}) {
    const enableAiTypeset = options.enableAiTypeset !== false;
  ...
  function enhanceTextarea(textarea) {
    ...
    const enableAiTypeset = !AI_TYPESET_DISABLED_FIELD_IDS.has(textarea.id);
